...
def setup_stripe():
    ...
    if not STRIPE_SECRET:
        print("  WARNING: No Stripe key. Add STRIPE_SECRET in Railway Variables.")
        return
    with _db_lock:
...
<style>
:root{--red:#cc0000;--red2:#990000;--black:#0a0a0a;--white:#ffffff;--off:#f8f8f8;--border:#e0e0e0;--muted:#666;--mono:'JetBrains Mono',monospace;--sans:'DM Sans',sans-serif;--display:'Bebas Neue',sans-serif}
...
.chain-s{font-family:var(--mono);font-size:11px;color:#00ff88}
...
.sec{padding:60px 20px}.comp-grid,.dec-grid,.how-grid,.price-grid,.legal-grid{grid-template-columns:1fr}
...
<section class="hero">
  <div class="hero-inner">
    <div>
      ...
      <p class="hero-p">AILeash is a real-time AI action governance engine. Every AI decision is scored, audited, and controlled before it executes. Built specifically for EU AI Act compliance.</p>
      <div class="btns">
    ...
    <div class="terminal">
      ...
      <div class="term-body">
        ...
        <div>&nbsp;&nbsp;<span class="tk">"reasons"</span>: [<span class="ts">"unsafe_country"</span>, <span class="ts">"behaviour_anomaly"</span>, <span class="ts">"high_amount"</span>],</div>
...
<section class="sec" id="compliance">
  <div class="sec-inner">
    ...
    <div class="comp-grid">
      <div class="comp-card"><div class="comp-ref">Art. 9 — Risk Management</div><h3>Continuous Assessment</h3><p>Every AI action is assessed in real time using a proprietary multi-signal risk engine. Risk accumulates across user sessions. No action escapes governance assessment.</p></div>
      <div class="comp-card"><div class="comp-ref">Art. 12 — Record Keeping</div><h3>Tamper-Evident Chain</h3><p>SHA-256 chained ledger initialised from GENESIS block. Every decision is cryptographically linked to the previous record. Chain integrity verifiable at any time.</p></div>
      <div class="comp-card"><div class="comp-ref">Art. 13 — Transparency</div><h3>Explainable Decisions</h3><p>Every ALLOW, CHALLENGE, or BLOCK decision returns human-readable reasons. No black boxes. Every factor surfaced for regulatory review.</p></div>
      <div class="comp-card"><div class="comp-ref">Art. 17 — Quality Management</div><h3>Deterministic Scoring</h3><p>Same inputs always produce the same output. Scoring logic is version-locked and fully reproducible for regulatory audit.</p></div>
      <div class="comp-card"><div class="comp-ref">GDPR Art. 22</div><h3>Human Oversight</h3><p>CHALLENGE decisions create a mandatory human review pathway. No fully automated high-risk decisions without oversight capability.</p></div>
      <div class="comp-card"><div class="comp-ref">ISO 42001</div><h3>AI Management System</h3><p>Aligned with ISO 42001. Risk identification, treatment, monitoring, and improvement baked into the core architecture.</p></div>
    </div>
  </div>
</section>
...
<section class="sec" id="how">
  <div class="sec-inner">
    ...
    <p class="sec-sub">Every AI action passes through the AILeash governance engine before it executes. The process is real-time, automatic, and fully audited.</p>
    <div class="how-grid">
      <div class="how-card">
        <div class="how-num">01</div>
        <h3>Send The Action</h3>
        <p>Your AI agent sends the proposed action to AILeash via a single API call before executing. Amount, location, device context, and behavioural signals are included in the request.</p>
      </div>
      <div class="how-card">
        <div class="how-num">02</div>
        <h3>Proprietary Scoring</h3>
        <p>AILeash runs the action through a proprietary multi-signal risk engine. The engine analyses behavioural patterns, velocity, geography, and trust history to produce a composite risk score.</p>
      </div>
      <div class="how-card">
        <div class="how-num">03</div>
        <h3>Decision & Audit</h3>
        <p>A decision is returned in under 15ms — ALLOW, CHALLENGE, or BLOCK — with human-readable reasons. Every decision is permanently written to the SHA-256 tamper-evident audit chain.</p>
      </div>
    </div>
    <div class="dec-grid">
      <div class="dec-card dec-a"><div class="dec-v">ALLOW</div><div class="dec-r">LOW RISK — ACTION PROCEEDS</div><div class="dec-d">Action is within acceptable risk parameters. Trust maintained. SHA-256 audit record written to chain.</div></div>
      <div class="dec-card dec-c"><div class="dec-v">CHALLENGE</div><div class="dec-r">ELEVATED RISK — HUMAN REVIEW</div><div class="dec-d">Action flagged for human review. GDPR Art.22 oversight pathway triggered. Full signal breakdown returned.</div></div>
      <div class="dec-card dec-b"><div class="dec-v">BLOCK</div><div class="dec-r">HIGH RISK — ACTION HALTED</div><div class="dec-d">Action stopped immediately. Trust decays. Full explainability reasons returned. Tamper-evident audit record written.</div></div>
    </div>
    <div class="chain-box">
      <div class="chain-hdr"><span class="chain-t">SHA-256 Audit Ledger — Cryptographic Integrity</span><span class="chain-s">● Chain Intact</span></div>
      <div class="chain-row"><span class="chain-n">GENESIS</span><span style="color:#333">→</span><span class="chain-h">Initialisation block — all subsequent records chain from here</span><span class="cdb">ORIGIN</span></div>
      <div class="chain-row"><span class="chain-n">BLOCK #1</span><span style="color:#333">→</span><span class="chain-h">prev_hash links to GENESIS | decision + signals + timestamp hashed to SHA-256</span><span class="cda">ALLOW</span></div>
      <div class="chain-row"><span class="chain-n">BLOCK #2</span><span style="color:#333">→</span><span class="chain-h">prev_hash links to Block #1 | any tampering breaks the chain</span><span class="cdc">CHALLENGE</span></div>
      <div class="chain-row"><span class="chain-n">BLOCK #N</span><span style="color:#333">→</span><span class="chain-h">Chain integrity verifiable at any time via GET /audit/verify — mathematically tamper-proof</span><span style="color:#555">VERIFIED</span></div>
    </div>
  </div>
</section>
...
<section class="sec" id="legal" style="background:#f8f8f8">
  <div class="sec-inner">
    ...
    <p class="sec-sub">The specific articles of EU law that AILeash is designed to address. Not a substitute for legal advice — but a technically grounded compliance foundation.</p>
    <div class="legal-grid">
      ...
      <div class="legal-card"><div class="legal-act">EU AI Act — Reg. 2024/1689 — Art. 9</div><h3>Risk Management System</h3><p>Requires a continuous, iterative risk management process throughout the entire AI system lifecycle. Must identify known and foreseeable risks, estimate and evaluate them, adopt appropriate measures, and test implementation.</p></div>
      <div class="legal-card"><div class="legal-act">EU AI Act — Reg. 2024/1689 — Art. 12</div><h3>Record Keeping & Logging</h3><p>High-risk AI systems must have automatic logging capabilities ensuring traceability throughout operation. AILeash's SHA-256 chained ledger provides mathematically verifiable log integrity — any tampering is detectable at /audit/verify.</p></div>
      <div class="legal-card"><div class="legal-act">EU AI Act — Reg. 2024/1689 — Art. 13</div><h3>Transparency & Information</h3><p>High-risk AI systems must be sufficiently transparent to enable deployers to interpret outputs. Every AILeash decision includes human-readable explainability reasons available for regulatory review.</p></div>
      <div class="legal-card"><div class="legal-act">GDPR — Reg. 2016/679 — Art. 22</div><h3>Automated Decision-Making</h3><p>Data subjects have the right not to be subject to decisions based solely on automated processing. AILeash's CHALLENGE decision class triggers mandatory human review — a legally defensible oversight pathway.</p></div>
      <div class="legal-card"><div class="legal-act">ISO/IEC 42001:2023</div><h3>AI Management Systems</h3><p>Specifies requirements for establishing, implementing, and improving an AI management system. AILeash's continuous risk assessment, tamper-evident audit trail, and explainable decisions align with the standard's core requirements.</p></div>
    </div>
  </div>
</section>
...
<footer>
  <div class="foot-inner">
    <div>
      ...
      <p class="foot-desc">Production-grade AI governance and compliance infrastructure. Built for EU AI Act enforcement. SHA-256 tamper-evident audit chain. Zero dependencies.</p>
    </div>
    <div class="foot-col">
      <h4>Product</h4>
      <a href="#compliance">Compliance</a>
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if path=="/signup":
            ...
            if not STRIPE_SECRET: err(self,"Stripe not configured"); return
            if not STRIPE_PRICE_ID: err(self,"Stripe not ready"); return
