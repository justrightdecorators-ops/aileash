...
<div class="wrap">
  ...
  <section>
    <h2>Joining</h2>
    <p class="sec-note">Submitting a tip takes one request. No account needed to send one, and none needed to check anyone else's.</p>
...

{
  ...
  "ts":    "2026-08-02T14:00:00Z"
    ...
    <p><code>url</code> is optional and worth sending: it's the address we fetch to check your tip independently, which is the difference between confirmed and self-declared. <code>ts</code> is optional too, epoch or ISO.</p>
    <p>Running a chain in the other direction — recording ours as we record yours — is what makes it mutual rather than us keeping a list. If you operate a platform in this space and you're willing to have your history held somewhere you don't control, get in touch and we'll walk through it.</p>
  </section>
