...
def pull_one(peer):
    ...
    # Field names here must match what modules/witness.py reads out of the
    # body: peer, tip, peer_ts (epoch seconds). Not the same names we use
    # when pushing to someone else's endpoint.
