...
@media(max-width:900px){
  nav{padding:16px 20px}.nav-r a:not(.nav-cta){display:none}
  .hero{padding:100px 20px 60px}.hero-grid{grid-template-columns:1fr;gap:48px}
  .stats-inner{grid-template-columns:repeat(2,1fr);padding:0 20px}
  .sec{padding:70px 20px}.comp-grid,.dec-grid,.price-grid,.legal-grid{grid-template-columns:1fr}
  .signup-sec{padding:70px 20px}footer{padding:48px 20px}
}
</style>
</head>
<body>
...
<section class="hero">
  <div class="hero-grid">
    <div>
      ...
      <h1>Every AI action.<br><span class="cy">Scored.</span> <span class="re">Audited.</span><br>Controlled.</h1>
      <p class="hero-p">AILeash is production-grade AI governance infrastructure. Real-time risk scoring using a 9-signal weighted algorithm, SHA-256 chained audit ledger, EWMA anomaly detection, and per-user trust decay. Built for EU AI Act compliance.</p>
      <div class="btns">
    ...
    <div class="term">
      ...
      <div class="term-body">
        <div class="tc">// POST /govern — wire transfer attempt</div>
        <div>{</div>
        ...
        <div>}</div>
        <br>
        <div class="tc">// Response — 12ms</div>
        <div>{</div>
...
<section class="stats-bar">
  <div class="stats-inner">
    ...
    <div><div class="stat-n">Aug 26</div><div class="stat-l">EU AI Act</div></div>
  </div>
</section>
<section class="sec" id="compliance">
  <div class="sec-inner">
    <div class="lbl">Regulatory Compliance</div>
    <h2>Built for the EU AI Act.</h2>
    <p class="sec-sub">Regulation 2024/1689 mandates risk management, audit trails, and transparency for AI systems. AILeash implements every required layer.</p>
    <div class="comp-grid">
      <div class="comp-card"><div class="comp-art">ART. 9 — RISK MANAGEMENT</div><h3>Continuous Risk Assessment</h3><p>Every AI action scored against 9 weighted signals in real time. Risk accumulates across sessions via EWMA trust decay. No action escapes assessment.</p></div>
      <div class="comp-card"><div class="comp-art">ART. 12 — RECORD KEEPING</div><h3>Tamper-Evident Audit Chain</h3><p>SHA-256 chained ledger. Every decision cryptographically linked to the previous. Any tampering breaks the chain. Full audit trail retained indefinitely.</p></div>
      <div class="comp-card"><div class="comp-art">ART. 13 — TRANSPARENCY</div><h3>Explainable Decisions</h3><p>Every ALLOW, CHALLENGE, or BLOCK includes human-readable reasons. No black boxes. Every factor that influenced the decision is surfaced.</p></div>
      <div class="comp-card"><div class="comp-art">ART. 17 — QUALITY MANAGEMENT</div><h3>Consistent Governance</h3><p>Deterministic scoring algorithm. Same inputs always produce the same output. Version-locked scoring weights. Full reproducibility for regulatory review.</p></div>
      <div class="comp-card"><div class="comp-art">GDPR ART. 22</div><h3>Automated Decision Control</h3><p>CHALLENGE decisions trigger human review. No fully automated high-risk decisions without oversight capability. GDPR Article 22 compliant by design.</p></div>
      <div class="comp-card"><div class="comp-art">ISO 42001</div><h3>AI Management System</h3><p>Aligned with ISO 42001 AI management system standard. Risk identification, treatment, and monitoring baked into the core architecture.</p></div>
    </div>
  </div>
</section>
<section class="sec" id="algorithm" style="padding-top:0">
  <div class="sec-inner">
    <div class="lbl">Scoring Algorithm</div>
    <h2>9 signals. One score.</h2>
    <p class="sec-sub">Every weight, every threshold, every decay function — documented and transparent.</p>
    <table class="algo-table">
      <thead><tr><th>Signal</th><th>Weight</th><th>Method</th><th>Trigger</th></tr></thead>
      <tbody>
        <tr><td>Trust Score (inverted)</td><td class="wt">30%</td><td>EWMA decay — asymmetric build/drop</td><td>trust < 0.4 → low_trust</td></tr>
        <tr><td>Velocity — 60 second</td><td class="wt">15%</td><td>Sliding deque window, real-time prune</td><td>> 10 req/min → velocity_spike</td></tr>
        <tr><td>Velocity — 5 minute</td><td class="wt">10%</td><td>Sliding deque window, real-time prune</td><td>Capped at 50 req/5min</td></tr>
        <tr><td>Velocity — 1 hour</td><td class="wt">10%</td><td>Sliding deque window, real-time prune</td><td>Capped at 200 req/hr</td></tr>
        <tr><td>Transaction Amount</td><td class="wt">15%</td><td>Log scale: log₁(amount)/log₁(10000)</td><td>> £500 → high_amount</td></tr>
        <tr><td>Device Risk</td><td class="wt">10%</td><td>Caller-supplied 0.0–1.0 score</td><td>> 0.5 → risky_device</td></tr>
        <tr><td>Behavioural Anomaly</td><td class="wt">10%</td><td>Caller-supplied EWMA anomaly score</td><td>> 0.5 → behaviour_anomaly</td></tr>
        <tr><td>Country Shift</td><td class="wt">+10%</td><td>Delta from last known country per user</td><td>New country → country_shift</td></tr>
        <tr><td>Unsafe Country</td><td class="wt">+10%</td><td>Allowlist: UK,US,DE,FR,CA,AU,NL,SE,NO,DK</td><td>Not in list → unsafe_country</td></tr>
      </tbody>
    </table>
    <div style="margin-top:40px">
      <div class="lbl">Trust Decay Function</div>
      <div class="chain-viz" style="font-size:13px;line-height:2.4">
        <div><span style="color:var(--accent3)">ALLOW</span> &nbsp;&nbsp;&nbsp;→ trust += (1 - trust) × 0.01</div>
        <div><span style="color:var(--warn)">CHALLENGE</span> → trust -= trust × 0.02</div>
        <div><span style="color:var(--accent2)">BLOCK</span> &nbsp;&nbsp;&nbsp;→ trust -= trust × 0.08 &nbsp;<span style="color:var(--muted)">// floor 0.05</span></div>
      </div>
    </div>
    <div class="dec-grid" style="margin-top:40px">
      <div class="dec-card dec-allow"><div class="dec-label">ALLOW</div><div class="dec-thresh">Score < 0.35</div><div class="dec-desc">Action proceeds. Trust increments. SHA-256 audit record written to chain.</div></div>
      <div class="dec-card dec-challenge"><div class="dec-label">CHALLENGE</div><div class="dec-thresh">Score 0.35 — 0.70</div><div class="dec-desc">Human review required. Trust decays. GDPR Art.22 pathway triggered.</div></div>
      <div class="dec-card dec-block"><div class="dec-label">BLOCK</div><div class="dec-thresh">Score > 0.70</div><div class="dec-desc">Action halted. Trust decays aggressively. Full signal breakdown returned.</div></div>
    </div>
    <div class="lbl" style="margin-top:60px">SHA-256 Audit Chain</div>
    <div class="chain-viz">
      <div class="chain-row"><div class="chain-block">BLOCK #0</div><div class="chain-arrow">→</div><div class="chain-hash">prev: GENESIS | hash: 8f91f82d8e3a19faf51f813e1b614be2...</div><div class="cdb">BLOCK</div></div>
      <div class="chain-row"><div class="chain-block">BLOCK #1</div><div class="chain-arrow">→</div><div class="chain-hash">prev: 8f91f82d... | hash: c4a9d1e8f2b7563a...</div><div class="cda">ALLOW</div></div>
      <div class="chain-row"><div class="chain-block">BLOCK #2</div><div class="chain-arrow">→</div><div class="chain-hash">prev: c4a9d1e8... | hash: 3b7f92a1d4e6c8...</div><div class="cdc">CHALLENGE</div></div>
      <div class="chain-row"><div class="chain-block">BLOCK #N</div><div class="chain-arrow">→</div><div class="chain-hash">Tamper any record → chain breaks → detected instantly at /audit/verify</div><div style="color:var(--muted);font-size:11px">VERIFIED</div></div>
    </div>
  </div>
</section>
<section class="sec" id="legal" style="padding-top:0">
  <div class="sec-inner">
    <div class="lbl">Legal Framework</div>
    <h2>Regulation references.</h2>
    <div class="legal-grid">
      <div class="legal-card"><div class="legal-ref">EU AI ACT — REGULATION 2024/1689</div><h3>High-Risk AI Systems</h3><p>Article 6 classifies AI systems used in critical infrastructure, employment, and financial services as high-risk. These systems must implement risk management, data governance, transparency, human oversight, and accuracy requirements before August 2026.</p></div>
      <div class="legal-card"><div class="legal-ref">ARTICLE 9 — RISK MANAGEMENT SYSTEM</div><h3>Continuous Risk Assessment</h3><p>Requires a continuous iterative process throughout the AI system lifecycle. AILeash implements real-time per-action scoring with persistent trust tracking across sessions — satisfying the continuous assessment requirement.</p></div>
      <div class="legal-card"><div class="legal-ref">ARTICLE 12 — RECORD KEEPING</div><h3>Automatic Log Generation</h3><p>High-risk AI systems must automatically log events throughout their operation. The SHA-256 chained audit ledger satisfies this requirement with cryptographic integrity — any tampering is mathematically detectable via /audit/verify.</p></div>
      <div class="legal-card"><div class="legal-ref">GDPR ARTICLE 22 — AUTOMATED DECISIONS</div><h3>Right to Human Review</h3><p>Individuals have the right not to be subject to solely automated decisions with significant effects. AILeash's CHALLENGE decision class creates a mandatory human review pathway, satisfying this requirement by design.</p></div>
    </div>
  </div>
</section>
<section class="sec" id="pricing" style="padding-top:0">
  <div class="sec-inner">
    ...
    <h2>Pay per action. Nothing else.</h2>
    <p class="sec-sub">No seats. No minimums on free tier. Scales exactly with your AI agent usage.</p>
    <div class="price-grid">
      <div class="price-card">
        <div class="price-tier">Free</div><div class="price-num">£0</div><div class="price-unit">1,000 actions/month</div>
        <ul class="price-features"><li>Full 9-signal governance engine</li><li>SHA-256 tamper-evident audit chain</li><li>ALLOW / CHALLENGE / BLOCK</li><li>Explainable decision reasons</li><li>REST API access</li></ul>
      ...
      <div class="price-card featured">
        ...
        <div class="price-tier">Pay As You Go</div><div class="price-num">£0.001</div><div class="price-unit">per action · billed monthly</div>
        <ul class="price-features"><li>Everything in Free</li><li>Unlimited actions</li><li>Stripe metered billing</li><li>Usage tracking</li><li>Email support</li></ul>
        <a href="#signup" class="btn-p" style="display:block;text-align:center;padding:12px;text-decoration:none">Get API Key</a>
      </div>
      <div class="price-card">
        <div class="price-tier">Enterprise</div><div class="price-num">Custom</div><div class="price-unit">flat rate · white-label · on-premise</div>
        <ul class="price-features"><li>Everything in Pay As You Go</li><li>On-premise deployment</li><li>White-label SDK</li><li>SLA + dedicated support</li><li>Compliance documentation pack</li></ul>
...
<section class="signup-sec" id="signup">
  <div class="signup-inner">
    <div class="lbl">Get Access</div>
    <h2>API key in 10 seconds.</h2>
    <p class="sec-sub" style="margin:0 auto;text-align:center">Enter your email. Get an API key. Start governing your AI actions.</p>
    <div class="form-wrap">
      <div class="fg"><label>Work Email</label><input type="email" id="emailInput" placeholder="you@company.com"></div>
...
<footer>
  ...
  <p style="margin-top:12px"><a href="https://aileash.onrender.com/" target="_blank">Live API</a> &nbsp;·&nbsp; <a href="https://github.com/justrightdecorators-ops/aileash" target="_blank">GitHub</a> &nbsp;·&nbsp; <a href="mailto:justin@monopcontent.com">Contact</a></p>
  <p style="margin-top:24px;font-size:11px;opacity:.3">© 2026 Monop Content · EU AI Act Compliant · SHA-256 Audit Chain</p>
</footer>
<script>
...
async function doSignup(){
  ...
  if(!email||!email.includes('@')){errEl.textContent='ERROR: Valid email required.';errEl.classList.add('show');return}
