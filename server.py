...
<style>
*{margin:0;padding:0;box-sizing:border-box}
body{background:#fff;color:#1a1a1a;font-family:-apple-system,Arial,sans-serif;line-height:1.7;padding:2rem}
nav{background:#fff;border-bottom:3px solid #cc0000;padding:1rem 2rem;display:flex;justify-content:space-between;align-items:center;margin:-2rem -2rem 2rem -2rem}
.logo{font-size:1.3rem;font-weight:900;color:#cc0000}
.logo span{color:#1a1a1a}
.wrap{max-width:800px;margin:0 auto;padding:2rem 0}
h1{font-size:2rem;font-weight:900;color:#cc0000;margin-bottom:.5rem}
h2{font-size:1.2rem;font-weight:700;color:#1a1a1a;margin:2rem 0 .5rem}
p{color:#555;margin-bottom:1rem;font-size:.95rem}
ul{margin-left:1.5rem;margin-bottom:1rem;color:#555;font-size:.95rem}
ul li{margin-bottom:.3rem}
.date{color:#aaa;font-size:.82rem;margin-bottom:2rem}
footer{border-top:1px solid #eee;margin-top:3rem;padding-top:1.5rem;text-align:center;color:#aaa;font-size:.8rem}
...
def privacy():
    return LEGAL_STYLE + """
<nav><a href="/" class="logo">AI<span>Leash</span></a></nav>
<div class="wrap">
<h1>Privacy Policy</h1>
<p class="date">Last updated: May 2026</p>

<h2>Who we are</h2>
<p>AILeash is operated by Monopcontent. Our website is sebbi.pro. Contact us at hello@monopcontent.com.</p>

<h2>What data we collect</h2>
<ul>
<li>Email address — when you sign up for a free API key or Pro subscription</li>
<li>Name and phone number — if you submit a contact form enquiry</li>
<li>AI action data — events you send to our /govern endpoint for risk scoring</li>
<li>Usage data — how many requests your API key has made</li>
</ul>

<h2>Why we collect it</h2>
<ul>
<li>Email — to issue your API key and manage your subscription</li>
<li>Contact details — to respond to your enquiry</li>
<li>Action data — to provide the governance and audit service you have requested</li>
</ul>

<h2>Legal basis</h2>
<p>We process your data on the basis of contract performance — you provide your email to receive our service, and we use it solely for that purpose.</p>

<h2>How long we keep it</h2>
<p>We keep your email and API key for as long as your account is active. If you cancel, we retain your audit chain data for 12 months then delete it. Contact us to request earlier deletion.</p>

<h2>Who we share it with</h2>
<ul>
<li>Stripe — our payment processor. They handle payment data. We never see your card details.</li>
<li>Railway — our hosting provider. Your data is hosted on their infrastructure.</li>
<li>Nobody else. We do not sell your data. Ever.</li>
</ul>

<h2>Your rights</h2>
<p>Under GDPR you have the right to access, correct, or delete your personal data at any time. Email hello@monopcontent.com and we will respond within 30 days.</p>

<h2>Cookies</h2>
<p>We do not use tracking cookies or advertising cookies. We use no third-party analytics.</p>

<h2>Contact</h2>
<p>hello@monopcontent.com</p>

<footer><a href="/">Back to AILeash</a> &nbsp;&mdash;&nbsp; <a href="/terms">Terms of Service</a> &nbsp;&mdash;&nbsp; <a href="/refunds">Refund Policy</a></footer>
</div>"""
...
<h2>Agreement</h2>
<p>By using AILeash at sebbi.pro you agree to these terms. If you do not agree, do not use the service.</p>

<h2>The service</h2>
<p>AILeash provides AI governance infrastructure including real-time risk scoring, audit logging, and compliance tooling via API. We provide a free tier of 1,000 governed requests and a Pro subscription for unlimited requests.</p>

<h2>Your responsibilities</h2>
<ul>
<li>You are responsible for keeping your API key secure</li>
<li>You must not share your API key with third parties outside your organisation</li>
<li>You must not use the service for illegal purposes</li>
<li>You must not attempt to circumvent rate limits or abuse the free tier</li>
</ul>

<h2>Compliance disclaimer</h2>
<p>AILeash implements core technical requirements of the EU AI Act and related frameworks. However, AILeash is a technical tool, not legal advice. Whether AILeash satisfies your specific legal obligations under the EU AI Act, UK AI framework, or any other regulation is a legal question. You must consult qualified legal counsel to confirm your compliance obligations. We accept no liability for regulatory penalties arising from your use or non-use of AILeash.</p>

<h2>Limitation of liability</h2>
<p>AILeash is provided as-is. We are not liable for any direct, indirect, or consequential damages arising from your use of the service, including but not limited to regulatory fines, data loss, or business interruption. Our total liability to you shall not exceed the amount you paid us in the three months preceding the claim.</p>

<h2>Availability</h2>
<p>We aim for high availability but do not guarantee 100% uptime. We are not liable for losses arising from service downtime.</p>

<h2>Termination</h2>
<p>We may suspend or terminate your account if you breach these terms. You may cancel your subscription at any time via your Stripe account dashboard.</p>
...
<footer><a href="/">Back to AILeash</a> &nbsp;&mdash;&nbsp; <a href="/privacy">Privacy Policy</a> &nbsp;&mdash;&nbsp; <a href="/refunds">Refund Policy</a></footer>
</div>"""
...
<h2>Free tier</h2>
<p>The free tier of 1,000 governed requests is provided at no cost. No refunds are applicable.</p>

<h2>Pro subscription</h2>
<p>Pro subscriptions are billed monthly at &pound;49/month. You may cancel at any time from your Stripe account dashboard. Cancellation takes effect at the end of your current billing period. We do not provide refunds for partial months.</p>

<h2>Exceptions</h2>
<p>If AILeash experiences a significant service outage of more than 24 continuous hours in any billing period, you may request a pro-rata refund for the period of outage by emailing hello@monopcontent.com within 14 days of the outage.</p>

<h2>How to cancel</h2>
<p>Log in to your Stripe customer portal or email hello@monopcontent.com and we will cancel your subscription immediately.</p>

<h2>Contact</h2>
<p>hello@monopcontent.com</p>

<footer><a href="/">Back to AILeash</a> &nbsp;&mdash;&nbsp; <a href="/privacy">Privacy Policy</a> &nbsp;&mdash;&nbsp; <a href="/terms">Terms of Service</a></footer>
</div>"""
