...
".engine-hero{text-align:center;margin-bottom:64px}",
".engine-hero h2{color:var(--white)}",
".engine-hero p{font-size:17px;color:rgba(255,255,255,0.45);max-width:640px;margin:0 auto;line-height:1.75}",
".engine-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:2px;background:rgba(255,255,255,0.04);margin-bottom:48px}",
".eg{background:var(--navy2);padding:32px;position:relative}",
".eg::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:var(--gold)}",
".eg-num{font-family:var(--mono);font-size:10px;color:var(--gold);letter-spacing:2px;text-transform:uppercase;margin-bottom:10px}",
".eg h3{font-family:var(--display);font-size:20px;color:var(--white);font-weight:900;margin-bottom:10px}",
".eg p{font-size:13px;color:rgba(255,255,255,0.4);line-height:1.7}",
".engine-compare{display:grid;grid-template-columns:1fr 1fr;gap:24px;margin-bottom:48px}",
".ec{border-radius:8px;padding:32px}",
...
".ec-label{font-family:var(--mono);font-size:10px;letter-spacing:2px;text-transform:uppercase;margin-bottom:14px}",
".ec-old .ec-label{color:#ff6b6b}.ec-new .ec-label{color:var(--gold)}",
".ec h3{font-family:var(--display);font-size:20px;font-weight:900;margin-bottom:14px}",
".ec-old h3{color:#ff6b6b}.ec-new h3{color:var(--gold)}",
".ec-list{display:flex;flex-direction:column;gap:8px}",
".ec-item{display:flex;align-items:center;gap:10px;font-size:13px;color:rgba(255,255,255,0.5);padding:8px 0;border-bottom:1px solid rgba(255,255,255,0.04)}",
".ec-old .ec-item::before{content:'X';color:#ff6b6b;font-family:var(--mono);font-size:10px;font-weight:700;flex-shrink:0}",
".ec-new .ec-item::before{content:'OK';color:var(--gold);font-family:var(--mono);font-size:10px;font-weight:700;flex-shrink:0}",
".engine-download{background:rgba(201,168,76,0.08);border:2px solid var(--gold);border-radius:8px;padding:40px;text-align:center;margin-bottom:0}",
".ed-title{font-family:var(--display);font-size:32px;color:var(--white);font-weight:900;margin-bottom:10px}",
".ed-sub{font-size:15px;color:rgba(255,255,255,0.4);margin-bottom:24px;line-height:1.7;max-width:540px;margin-left:auto;margin-right:auto}",
".ed-code{font-family:var(--mono);font-size:12px;color:#00ff88;background:rgba(0,0,0,0.4);padding:14px 20px;border-radius:4px;margin-bottom:24px;display:inline-block;border:1px solid rgba(0,255,136,0.15)}",
".ed-btns{display:flex;gap:14px;justify-content:center;flex-wrap:wrap}",
".node-visual{display:grid;grid-template-columns:repeat(5,1fr);gap:8px;margin:32px 0}",
...
".sec,.guardian-sec,.compliance-sec,.fair-sec,.pricing-sec,.signup-sec,.engine-sec{padding:52px 20px}",
".engine-grid,.engine-compare,.node-visual{grid-template-columns:1fr}",
"}",
"</style></head><body>",
COMMON_NAV,
...
'<p>Every customer gets their own sovereign governance engine. It runs on your hardware. Your data never leaves your network. We never see it. No central server. No single point of failure. No infrastructure bottleneck. Just your engine, your chain, your compliance — forever.</p>',
'</div>',
'<div class="engine-grid">',
'<div class="eg"><div class="eg-num">What you get</div><h3>Your Own Engine</h3><p>When you sign up, you download a single Python file. That file IS the governance engine. Nine-signal risk scoring, SHA-256 Merkle audit chain, EU AI Act compliance mapping — all of it — running locally on your hardware in under a second.</p></div>',
'<div class="eg"><div class="eg-num">Your data</div><h3>Stays With You</h3><p>Every audit record, every decision, every piece of evidence is sealed to a cryptographic chain that lives on your machine. Not our cloud. Not our servers. Yours. We cannot read it, alter it, or lose it. Neither can anyone else.</p></div>',
'<div class="eg"><div class="eg-num">How it scales</div><h3>Replicates Itself</h3><p>Need to protect 2,000 devices across 50 locations? The engine clones itself to each node with a single cryptographic handshake. No deployment team. No central installation server. One engine becomes two becomes two thousand — automatically.</p></div>',
'<div class="eg"><div class="eg-num">Your cost</div><h3>50p Per Device</h3><p>Because we have near-zero infrastructure costs at your scale, we pass that directly to you. Enterprise compliance vendors charge £50,000 a year for a fraction of this. We charge 50p per device per month because the architecture makes it possible.</p></div>',
'<div class="eg"><div class="eg-num">The audit chain</div><h3>Court-Admissible</h3><p>Every decision is cryptographically sealed — timestamp, email, IP address, decision — hashed with SHA-256 into a Merkle chain where tampering breaks every subsequent block. Admissible in UK courts. Verifiable by Ofcom, the ICO, and the Crown Prosecution Service.</p></div>',
'<div class="eg"><div class="eg-num">Child safety</div><h3>Guardian Built In</h3><p>The Guardian engine extends the same architecture with child-specific threat detection — grooming patterns, CSAM, psychological manipulation, cross-border risk. BLOCK threshold lowered to 0.60. CSAM triggers mandatory BLOCK regardless of score. Evidence preserved instantly for law enforcement.</p></div>',
'</div>',
...
'<div class="ec-item">Single point of failure — their outage is your breach</div>',
'<div class="ec-item">£50,000+ per year enterprise contracts</div>',
'<div class="ec-item">Months to deploy — integration teams required</div>',
'<div class="ec-item">You depend on them forever — lock-in by design</div>',
'<div class="ec-item">Audit chain they control — not you</div>',
'</div></div>',
'<div class="ec ec-new">',
...
'<div class="ec-item">No central server — your engine runs offline if needed</div>',
'<div class="ec-item">50p per device per month — no contracts</div>',
'<div class="ec-item">60 seconds to deploy — one file, one API key</div>',
'<div class="ec-item">You own the engine — we cannot take it away</div>',
'<div class="ec-item">Your audit chain — cryptographically yours</div>',
'</div></div>',
'</div>',
...
'<p class="ed-sub">One Python file. Zero external dependencies. Runs on any device with Python installed. Your governance engine, your audit chain, your compliance — sovereign and permanent from the moment you download it.</p>',
