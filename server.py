...
<section class="hero">
  <div class="hero-inner">
    ...
    <p class="hero-sub">Four products. All free to integrate. <strong>Your users pay for protection.</strong> You set what they pay on AILeash, SonicBoom and Sentinel — we take 50p per device per month, you keep the rest. Guardian is free for every family, forever.</p>
    <div class="hero-btns">
