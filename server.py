...
<div class="products-inner">
  ...
  <div class="product-cards">
    ...
    <div class="pc pc-sb">
      ...
      <h3>SonicBoom</h3>
      <p class="pc-desc">One-line plugin for any existing cloud AI infrastructure. AWS, Azure, GCP, OpenAI &mdash; it does not matter. Your system stays exactly as it is. Every decision drops from 200ms to 6ms. Full audit chain added automatically.</p>
      <div class="pc-features">
        <div class="pcf">6ms decisions &mdash; down from 200ms &mdash; one line of code</div>
...
<div class="sb-inner">
  ...
  <h2 style="color:var(--white)">Your AI runs at 200ms. <em>SonicBoom fixes that.</em></h2>
  <p style="font-size:15px;color:rgba(255,255,255,0.4);max-width:620px;line-height:1.75;margin-bottom:40px">One line of code around your existing AI calls. Nothing changes in your system. Every decision drops to 6ms. Full SHA-256 audit chain added automatically. EU AI Act and Ofcom compliant from the moment you integrate. Works with any cloud infrastructure.</p>
  <div class="speed-compare">
    <div class="sc-before"><div class="sc-label">Before SonicBoom</div><div class="sc-speed">200</div><div class="sc-unit">milliseconds</div></div>
    <div class="sc-arrow">&#8594;</div>
    <div class="sc-after"><div class="sc-label">After SonicBoom</div><div class="sc-speed">6</div><div class="sc-unit">milliseconds</div></div>
  </div>
