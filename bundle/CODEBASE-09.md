...
def _observe(ctx, api_key, data):
    ...
    if liveness == LIVENESS_MATCH:
        out["what_self_consistent_means"] = ("Your url served exactly the tip you "
                                             "submitted. Both came from you, so this "
                                             "records self-consistency, not verification "
