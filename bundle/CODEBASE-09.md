...
656 lines, 26135 bytes

```python
"""
modules/ots.py  v1.1  -  serve the OpenTimestamps proofs, and upgrade them
...
def _status():
    ...
    out["auto_upgrade"] = {
        ...
        "note": ("Runs oldest first in small batches, skipping proofs already "
                 "confirmed. The calendars are free infrastructure run by "
...
def _upgrade(data):
    ...
    if auto:
        # Oldest first, old enough to have confirmed, not already confirmed.
    ...
    return {
        ...
        "pending_vs_confirmed": {
            ...
            "the_gap": "A proof does not become confirmed on its own. It must "
                       ...
                       "timer, oldest first, skipping ones already done.",
        },
        "routes": {
