...
Run with: uvicorn sebbi_core_module:app --reload
"""
...
async def record_witness_with_provenance(
    ...
    x_sebbi_signature: str = Header(None) # Made optional for easy local testing
):
    """
    ...
    return WitnessBlockResponse(
        ...
        network_node="uk-blyth-node-01" # Geolocation node identifier
    )
...
if __name__ == "__main__":
    ...
    # Mocking a Claude API interaction
    ...
    print(f"Sending prompt hash and watermarked payload to Sebbi node...")
    ...
    if proof:
        ...
        print(f"\nYour immutable SHA-256 seal is: {proof['sha256_composite_seal']}")
        print("This proves the Anthropic origin AND prevents any downstream tampering.")
