...
145 lines, 5902 bytes

```python
"""
modules/homelink.py  v1.4.0
Adds the "Auditors", "Deep Run", "Agent Room", "Machine readable" and "Agent Passport" buttons to the sebbi.pro homepage without
...
BUTTON = (
    ...
    b'<a href="/auditors" style="background:#c9a84c;color:#0a0f1e;border:0;padding:15px 22px;'
    b'font-size:15px;font-weight:700;box-shadow:0 0 30px rgba(201,168,76,.55),0 6px 24px rgba(0,0,0,.4)">'
    b'&#9878; AUDITORS &rarr;</a>'
...
def handle(method, action, data, api_key, ctx):
    ...
    return ({"module": "homelink", "version": VERSION, "armed": armed,
             "adds": "Auditors (/auditors), Deep Run (/game), Agent Room (/room), Machine readable (/prove) and Agent Passport (/passport) buttons",
