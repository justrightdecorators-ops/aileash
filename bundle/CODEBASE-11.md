...
def _read_live_chain(ctx):
    ...
    candidates = [
        "SELECT seal, height FROM chain ORDER BY height DESC LIMIT 1",
        "SELECT hash AS seal, height FROM chain ORDER BY height DESC LIMIT 1",
        "SELECT seal, rowid AS height FROM chain ORDER BY rowid DESC LIMIT 1",
        "SELECT seal, id AS height FROM blocks ORDER BY id DESC LIMIT 1",
        "SELECT hash AS seal, id AS height FROM blocks ORDER BY id DESC LIMIT 1",
    ]
