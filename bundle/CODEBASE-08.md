...
615 lines, 25668 bytes

```python
"""
modules/machine.py  v1.0  -  the machine
...
BASE = SITE + "/x/machine/"
UA = "sebbi-machine/1.0 (+https://sebbi.pro/x/machine/help)"
TIMEOUT = 30
...
def cmd_bitcoin(q):
    ...
    try:
        ...
        ev["proof_is_for_this_tip"] = (
            det.file_digest == hashlib.sha256(bytes.fromhex(tip)).digest())
