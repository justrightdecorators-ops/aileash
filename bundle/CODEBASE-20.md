...
<section class="hero">
  <div class="hero-in">
    ...
    <h1>Own the business.<br>Not the <em>job.</em></h1>
    <p class="hero-sub">You buy a phone safety package at <b>50p per device per month</b>. You sell it at your price, under your name. Every customer pays you again next month whether you worked or not &mdash; and after two years you're not just earning, <b>you own something worth selling.</b></p>
    <div class="flow">
...
<!-- ========== SIGNAL PACKS ========== -->
<section class="sec">
  <span class="eyebrow">05 &middot; The reason nobody cancels</span>
  <div class="spotlight">
    <h3>Signal Packs &mdash;<br>they <em>build their own.</em></h3>
    <p>This is the part that makes the money stick, and it's the part no competitor has. A Signal Pack is a set of rules <b>the customer writes themselves</b>: which numbers get through to their child, which sites are allowed, what counts as unusual for this particular person, what should trigger an alert at two in the morning.</p>
    <div class="sp-grid">
      <div class="sp"><div class="t">They own it</div><p>The rules are theirs, not a setting we chose. It fits their family, their business, their life.</p></div>
      <div class="sp"><div class="t">They've put work in</div><p>An hour spent building your own rules is an hour you won't throw away by cancelling next month.</p></div>
      <div class="sp"><div class="t">It grows with them</div><p>The pack for an eleven-year-old isn't the pack for a fifteen-year-old. They change it. They stay.</p></div>
      <div class="sp"><div class="t">You can build packs too</div><p>Make a pack for your own market &mdash; a school, a taxi firm, a care agency &mdash; and hand it to every customer you sign.</p></div>
    </div>
    <div class="say"><div class="k">Say this</div><p>&ldquo;You set the rules yourself. It's your phone and your family &mdash; nobody else decides what's normal for you.&rdquo;</p></div>
    <div class="note note-gold" style="margin-top:16px"><b>Why this matters to your business:</b> churn is the single number that decides whether your book is worth anything. Every customer who builds a pack is a customer who doesn't leave &mdash; and <b>every point of churn you avoid raises what the whole book sells for.</b> Get every new customer to build a pack in the first week. It's the highest-value ten minutes of your month.</div>
  </div>
</section>

<!-- ========== WORDS ========== -->
<section class="sec" id="words">
  <span class="eyebrow">06 &middot; Your first ten customers</span>
...
<!-- ========== CLAIMS ========== -->
<section class="sec">
  <span class="eyebrow">07 &middot; How the good ones sell it</span>
...
<section class="sec" id="signup">
  <span class="eyebrow">08 &middot; Start</span>
  <div class="signup">
...
<!-- ========== FAQ ========== -->
<section class="sec">
  <span class="eyebrow">09 &middot; Straight answers</span>
