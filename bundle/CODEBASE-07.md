...
1040 lines, 43193 bytes

```python
"""
modules/integrity.py  v1.3  -  the AI Integrity Declaration, and a public checker
...
CACHE_SECONDS = 600
USER_AGENT = "sebbi-integrity-checker/1.3 (+https://sebbi.pro/x/integrity/status)"
