...
1346 lines, 58419 bytes

```python
"""
modules/integrity.py  v1.4.2  -  the AI Integrity Declaration, a public checker,
...
SELF = {
    ...
    "known_gaps": [
        ...
        "Anchoring: tips are stamped to Bitcoin hourly and confirm a few hours later; the level is claimed only once the checker has verified a confirmed current-chain proof.",
    ],
}
...
CACHE_SECONDS = 600
USER_AGENT = "sebbi-integrity-checker/1.4.2 (+https://sebbi.pro/x/integrity/status)"
