...
1117 lines, 48711 bytes

```python
"""
modules/peer.py  v1.3.0  --  signed peer submission (shared secret)
    ...
    with ctx["lock"]:
        ...
        out = {
            ...
            "receipt": {"audit_hash": audit_hash,
                        ...
                        "receipt_seq_scope": "per-peer, this lane",
                        "key_seq": receipt_seq},
            "verify": {
                "inclusion": "/x/complete/prove",
                "ancestry": "/x/consistency/ancestor?tip=<any tip we served>",
                "append_only": "/x/consistency/proof?first=&second=",
                "gapless": "receipt_seq increments by exactly one per "
                           "accepted submission from this peer. Two "
                           "receipts numbered N and N+2 prove a third "
                           "exists and you did not receive it.",
            },
        }
