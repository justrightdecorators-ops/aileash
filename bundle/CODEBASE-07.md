...
1346 lines, 58233 bytes

```python
"""
modules/integrity.py  v1.4.1  -  the AI Integrity Declaration, a public checker,
...
CACHE_SECONDS = 600
USER_AGENT = "sebbi-integrity-checker/1.4.1 (+https://sebbi.pro/x/integrity/status)"
