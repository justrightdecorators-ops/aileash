...
140 lines, 5458 bytes

```python
"""
modules/homelink.py  v1.2.0
Adds the "Agent Room", "Machine readable" and "Agent Passport" buttons to the sebbi.pro homepage without
...
def handle(method, action, data, api_key, ctx):
    ...
    return ({"module": "homelink", "version": VERSION, "armed": armed,
             "adds": "Agent Room (/room), Machine readable (/prove) and Agent Passport (/passport) buttons",
